...
| [`mucha-gpt-image-studio`](skills/mucha-gpt-image-studio/) | Create original or photo-guided Alphonse Mucha-inspired Art Nouveau avatars, pet portraits, posters, menus, invitations, backgrounds, and wallpapers. [English](skills/mucha-gpt-image-studio/README.md) · [简体中文](skills/mucha-gpt-image-studio/README.zh-CN.md) | A native image tool, or [oo CLI](https://oomol.com) with the `gpt-image-2` companion |
